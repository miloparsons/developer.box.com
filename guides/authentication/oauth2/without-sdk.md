...
1. [承認URLを構成する](#1-configure-authorization-url)
2. [ユーザーをBoxウェブサイトにリダイレクトする](#2-redirect-user)
3. [ユーザーがアプリケーションにアクセス権限を付与する](#3-user-grants-application-access)
4. [承認コードをアクセストークンと交換する](#4-exchange-code)
